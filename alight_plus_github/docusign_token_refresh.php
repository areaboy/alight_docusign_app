...
echo "<script>alert('Docusign Access Token Successfully Refreshed.. Please Continue with Your Submission')</script>";
echo "<div id='alertdata_recnv' style='color:white;background:green;padding:6px;'>Docusign Access Token Successfully Refreshed.. Please Continue with Your Submission</div>";
